...
public class RegistroVentas2 {
    public static void main(String[] args) {
        ...
        while (hay_clientes) {
            ...
            double dinero_recibido = 0;
            while (dinero_recibido < total_pagar) {
                System.out.print("Ingrese la cantidad con la que paga el cliente: ");
                dinero_recibido = input.nextDouble();
                if (dinero_recibido < total_pagar) {
